import React, { useState, useEffect, memo, useRef, useCallback, useMemo, useId } from 'react';
...
function Console(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...editorProps
  }, logs === null || logs === void 0 ? void 0 : logs.map((log, index) => /*#__PURE__*/React.createElement("p", {
    key: index,
    style: {
...
function CSSEditor(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(de, {
    ...editorProps,
    language: "css",
    theme: "vs-dark",
    value: code,
...
export { CSSEditor, Console, HTMLEditor, JSEditor, useCSSEditor, useConsole, useEditor, useHTMLEditor, useJSEditor };
